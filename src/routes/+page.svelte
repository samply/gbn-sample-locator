<script lang="ts">
	...
	let range = (size: number, startAt = 0) => [...Array(size).keys()].map((i) => i + startAt);
</script>
...
<div class="banner">
	<div class="banner">
		...
		<div class="banner-text">
			...
			<h2>Search for human biosamples and associated data across multiple biobanks</h2>
		</div>
	</div>

	<div class="search-wrapper">
		<div class="search">
			<lens-search-bar-multiple noMatchesFoundMessage="We couldn't find any matches for your search"
			></lens-search-bar-multiple>
			<lens-info-button noQueryMessage="An empty search will return all results" showQuery="true"
			></lens-info-button>
	...
	{:then { optionsJSON, catalogueJSON }}
		...
		<div class="charts">
			...
			<div class="chart-wrapper chart-sample-kind">
				<lens-chart title="Specimens" catalogueGroupCode="sample_kind" chartType="bar">
				</lens-chart>
			</div>
